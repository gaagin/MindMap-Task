...
export type ViewMode = 'canvas' | 'kanban' | 'mobile-list' | 'calendar' | 'gantt' | 'table' | 'eisenhower' | 'cards';
...
export interface TaskNode {
  ...
  notionLastSyncedAt?: string; // ISO string timestamp when this task was last synced with Notion
  ...
  defaultView?: 'canvas' | 'kanban' | 'mobile-list' | 'calendar' | 'gantt' | 'table' | 'eisenhower' | 'cards'; // Optional view mode to display by default when focused
  containerViewMode?: 'list' | 'kanban' | 'calendar' | 'gantt' | 'table' | 'canvas' | 'cards'; // Optional default nested view inside container
